...
describe('JWT client', () => {
    ...
    it('should create a jwt', () => {
        const JWT = googleauth_1.default.jwtclient;
...
describe('Compute client', () => {
    const Compute = googleauth_1.default.computeclient;
...
describe('OAuth2 client', () => {
    ...
    before((done) => {
        ...
        async.parallel([
            ...
            (cb) => {
                utils_1.default.loadApi(google, 'urlshortener', 'v1', {}, cb);
            }
        ], (err, apis) => {
            if (err) {
                return done(err);
    ...
    it('should not error if only refresh token is set', () => {
        ...
        assert.doesNotThrow(() => {
            ...
            localUrlshortener.url.get(options, utils_1.default.noop);
            remoteUrlshortener.url.get(options, utils_1.default.noop);
        });
    });
